...
export async function run(provider: NetworkProvider, args: string[]) {
    ...
    const new_jetton_address = Address.parse(await ui.input("Old jetton address: "));
    ...
    const body = beginCell()
        ...
        .storeUint(0, 64)
        .storeCoins(Number(await ui.input("Old jettons amount: ")) * (10 ** parseInt(await ui.input("Old jetton decimals: "))))
